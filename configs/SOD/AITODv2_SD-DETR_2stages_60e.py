...
model = dict(
    ...
    bbox_head=dict(
        ...
        loss_cls=dict(
            ...
            alpha=0.25,
            loss_weight=2.0),
        loss_bbox=dict(type='L1Loss', loss_weight=5.0), # change from L1Loss to SmoothL1loss
        loss_iou=dict(type='GIoULoss', loss_weight=2.0)), # change from GIoULoss to WassersteinLoss
